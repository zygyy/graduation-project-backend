...
import com.zy.config.AliyunConfig;
...
public class FileUploadServiceImpl {
     ...
     */
    public FileUploadResponse upload(MultipartFile uploadFile) {
        // 校验图片格式
        ...
        FileUploadResponse fileUploadResult = new FileUploadResponse();
        if (!isLegal) {
     ...
     * @email gaojun56@163.com
     */
    public FileUploadResponse delete(String objectName) {
